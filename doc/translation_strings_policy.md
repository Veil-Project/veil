...
This document provides guidelines for internationalization of the Veil software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `veil_en.ts` remains unchanged.
