...
First off, due to the delay in the debian Package Manger updating their debootstrap version It is suggested that you use Ubuntu 18.04.1 server as the host VM OS. All other instructions should work fine.
...
Get the [Ubuntu 18.04.1 Server Iso](http://cdimage.ubuntu.com/releases/18.04/release/ubuntu-18.04.1-server-amd64.iso).
This DVD image can be [validated](http://cdimage.ubuntu.com/releases/18.04/release/SHA256SUMS) using a SHA256 hashing tool, for example on
Unixy OSes by entering the following in a terminal:

    echo "a5b0ea5918f850124f3d72ef4b85bda82f0fcd02ec721be19c1a6952791c8ee8  ubuntu-18.04.1-server-amd64.iso" | sha256sum -c
    # (must return OK)
