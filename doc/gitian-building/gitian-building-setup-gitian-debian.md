...
- [Setting up Debian/Ubuntu for Gitian building](#setting-up-debian-for-gitian-building)
...
In this section we will be setting up the Debian/Ubuntu installation for Gitian building.
...
At the end Debian/Ubuntu is rebooted to make sure that the changes take effect. The steps in this
...
There is no `python-vm-builder` package in Debian/Ubuntu, so we need to install it from source ourselves,
