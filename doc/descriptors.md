# Support for Output Descriptors in Veil

Since Veil v1.0.0.0, there is support for Output Descriptors in the
...
existing Veil wallets, a convenience function `combo` is
