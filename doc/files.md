...
* veil.conf: contains configuration settings for veild or veil-qt
* veild.pid: stores the process id of veild while running
...
* debug.log: contains debug information and general logging generated by veild or veil-qt
