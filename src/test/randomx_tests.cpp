...
BOOST_AUTO_TEST_CASE(randomx_api_example1)
{
    ...
    BOOST_AUTO_TEST_CASE(randomx_api_veil_block_header)
    {
        const char myKey[] = "RandomX example key";
        const char myInput[] = "RandomX example input";
        char hash[RANDOMX_HASH_SIZE];
        ...
        uint256 nHeaderHash = header.GetRandomXHeaderHash();
        ...
        randomx_calculate_hash(myMachine, &nHeaderHash, sizeof uint256(), hash);
...
BOOST_AUTO_TEST_CASE(randomx_api_example2)
{
    const char myKey[] = "RandomX example key";
    const char myInput[] = "RandomX example input";
    char hash[RANDOMX_HASH_SIZE];
...
BOOST_AUTO_TEST_CASE(randomx_run_tests)
{
    char testHash[32];
