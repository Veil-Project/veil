...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    filter.insert(uint256S("0x1f784f7e4758b43e9be91188154df88b56e1b089a65159ff2a0f5dbe83b72a77"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x1f784f7e4758b43e9be91188154df88b56e1b089a65159ff2a0f5dbe83b72a77"));
    ...
    // Also match the 3rd transaction
    filter.insert(uint256S("0x2dfd9755c032081272b87a2f5123a4189380ed9dd7d52a50c3d2df2c6d690727"));
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x2dfd9755c032081272b87a2f5123a4189380ed9dd7d52a50c3d2df2c6d690727"));
...
BOOST_AUTO_TEST_CASE(merkle_block_2)
{
    ...
    filter.insert(uint256S("0x29339f4c8c5be8cd2b2ecbbde0f5889816c59922608e3e67c11628d556b5a74b"));
    std::cout << "block txs: " << block.vtx.size() << std::endl;
    CMerkleBlock merkleBlock(block, filter);
    BOOST_CHECK(merkleBlock.header.GetHash() == block.GetHash());
...
BOOST_AUTO_TEST_CASE(merkle_block_2_with_update_none)
{
    ...
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x29339f4c8c5be8cd2b2ecbbde0f5889816c59922608e3e67c11628d556b5a74b"));
    BOOST_CHECK(merkleBlock.vMatchedTxn[0].first == 0);
...
BOOST_AUTO_TEST_CASE(rolling_bloom)
{
    ...
    // Run test_veil with --log_level=message to see BOOST_TEST_MESSAGEs:
