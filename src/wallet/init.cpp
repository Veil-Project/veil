...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-mineprogpow", strprintf("Mine blocks using the CPU on the ProgPow hashing algo mining to true on the given number of threads (default: %u)", false), false, OptionsCategory::WALLET);
