    ...
    ui(new Ui::SettingsFaq04)
{
    ...
    ui->label_2->setText("Newly received <font color=#105aef>veil requires ~6 minutes</font> to fully confirm and become mintable (and spendable if using the “”Single Non-Autominting Address or Exchange-or-Service” mode).<br><br>"

                         "Newly minted <font color=#105aef>Zerocoin veil takes ~20 minutes</font> to become spendable. This delay is designed to protect users from ”timing attacks”, where their transactions are traceable by spending soon after minting.<br><br>"
