...
// emits a receivedPaymentRequest() signal for any payment
// requests that happened during startup.
//
// After startup, receivedPaymentRequest() happens as usual.
//
...
//
// The BIP70 payment protocol - and with it the GUI's OpenSSL and
// protobuf dependencies - has been removed, following upstream:
// only plain BIP21 veil: URIs are handled.
...
public:
    ...
    // process.
    // Note: if a URI is given, SelectParams(MAIN/TESTNET/DEVNET)
    ...
    // OptionsModel is used for getting display unit settings
