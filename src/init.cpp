...
void SetupServerArgs()
{
    ...
    std::vector<std::string> hidden_args = {"-rpcssl", "-benchmark", "-h", "-help", "-socks", "-tor", "-debugnet", "-whitelistalwaysrelay",
        ...
        "-allowselfsignedrootcertificates", "-choosedatadir", "-snapshotprompt", "-lang=<lang>", "-min", "-resetguisettings", "-rootcertificates=<file>", "-splash", "-uiplatform"};
...
std::string LicenseInfo()
{
    ...
    return  std::string("Copyright (C) 2009-2019 The Bitcoin Core developers") + "\n"
           ...
           "\n" +
           _("This product includes UPnP software written by Thomas Bernard.") +
           "\n";
}
...
void InitLogging()
{
    ...
    LogInstance().m_print_to_console = gArgs.GetBoolArg("-printtoconsole", false);
...
bool AppInitMain()
{
    ...
    // Gather some entropy once per minute (upstream 0.20: RandAddPeriodic)
